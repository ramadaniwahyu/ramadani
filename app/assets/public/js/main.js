...
$(function() {
// $('body').append('<div class="fix-bts" style=" position: fixed; top: 50vh; right: -118px; z-index: 1111; transition: all 0.2s ease 0s;"> <a title="Silakan klik untuk masuk dalam halaman Administrator" href="/masuk" class="fix-btn brand" style=" position: relative; margin-bottom: 5px; padding: 0 10px; display: block; height: 38px; line-height: 38px; background: #fff; text-transform: uppercase; font-size: 11px; box-shadow: 0 5px 30px rgba(0, 0, 0, 0.1); font-weight: 700; text-decoration: none; color: #000; "><img src="public/img/favico.png" style="width:20px; display:inline-block; vertical-align: middle; margin-right:15px;"/>Ramadani.My.Id</a></div>');
$('.fix-bts').on('mouseenter', function() {
$('.fix-bts').css({'right':'0'});
});
$('.fix-bts').on('mouseleave', function() {
$('.fix-bts').css({'right':'-118px'});
});
});